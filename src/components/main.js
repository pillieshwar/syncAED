...
export default function Main(props) {
  ...
  return (
    <Grid container spacing={3}>
        <Grid item xs={6}>
          <Paper elevation={0} className={classes.paper}><Maps /></Paper>
        </Grid>
        <Grid item xs={6}>
           ...
           <tbody>
             {
              ...
              <tr id={anomaly.id}>
                 ...
                 <td>
                   ...
                   <p style={{margin:"0", fontSize:'0.7rem'}}>{anomaly.event_time}</p>
  ...
  <tbody>
    {
      ...
      <tr>
        ...
        <td>
          ...
          <p style={{margin:"0", fontSize:'0.7rem'}}>{eventData.windowTime.startTime}</p>
          </div>
